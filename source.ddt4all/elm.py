...
#STN11xx TEST 1;AC  ; STI              ; I                  ; firmware ID
#STN11xx TEST 2;AC  ; STDI             ; DI                 ; hardware ID
#STN11xx TEST 3;AC  ; STPR             ; PR                 ; report protocol number
#STN11xx TEST 4;AC  ; STPBRR           ; PBRR               ; report current OBD protocol baud rate
#STN11xx TEST 5;AC  ; STPRS            ; PRS                ; manufacturer ID
#Reset all ;ACH ; ATZ              ; Z                  ; reset all
'''
...
def elm_checker(port, speed, logview, app):
    ...
    logview.append('Note for STN11xx -interfaces:')
    logview.append('Check the STN firmware update on www.scantool.net/scantool/downloads/')
    logview.append('For Media CAN (CAN Line 2) on STN1170, ELS27: Connect OBD pin 3 with 13 and 11 with 12.') 
    return True
